...
@section('content')
  <div class="welcomepage-content-container">
    <div class="landing-hero-page">
      <div class="parallax-container">
        <div class="parallax"><img src="./DesignPic/food8.jpg">
        </div>
      </div>
    </div>
    <div class="short-about-container">
      <div class="about-left">
        ...
        <h6 class="highlight">ABOUT US</h6>
      </div>
    ...
    <div class="landing-hero-two">
      <div class="parallax-container">
        <div class="parallax"><img src="./DesignPic/food13.jpg">
        </div>
      </div>
    </div>
